                ...
                <div class="property-meta entry-meta clearfix ">
                  <div class="meta-item">
                    ...
                    <div class="meta-inner-wrapper">
                      ...
                      <span class="meta-item-value">RP-2015-12</span>
                    </div>
                  </div>
                  <div class="meta-item">
                  ...
                  <div class="entry-content clearfix">
                    ...
                    <div class="property-additional-details clearfix">
                      ...
                      <ul class="property-additional-details-list clearfix">
                        ...
                        <li>
                          <dl>
                            <dt>Flooring</dt>
                            <dd>Ceramic Floor,Other</dd>
                          </dl>
                        </li>
                        <li>
                          <dl>
                            <dt>Waterfront Description:</dt>
                            <dd>Intracoastal Front,Ocean Access</dd>
                          </dl>
                        </li>
                        <li>
                          <dl>
                            <dt>View</dt>
                            <dd>Intracoastal View,Direct Ocean,Ocean View</dd>
                          </dl>
                        </li>
                        <li>
                          <dl>
                    ...
                    <div class="property-features">
                      ...
                      <ul class="property-features-list clearfix">
                        <li><a class="pointer">2 Stories</a></li>
                        <li><a class="pointer">Bike Path</a></li>
                        <li><a class="pointer">Central Cooling</a></li>
                        <li><a class="pointer">Jog Path</a></li>
                        <li><a class="pointer">Lawn</a></li>
                        <li><a class="pointer">Swimming Pool</a></li>
                      </ul>
                    </div>
                    <section class="property-video">
                      ...
                      <div class="placeholder-thumb format-video">
                        <a
                          class="video-popup pointer"
                          href="https://vimeo.com/301524875"
                          title="Virtual Tour"
                        >
                ...
                <section class="agent-sidebar-widget clearfix">
                  <div class="agent-content-wrapper agent-common-styles">
                    <div class="inner-wrapper clearfix">
                      <figure class="agent-image pointer">
                        <a>
                          <img
                            width="220"
                            height="220"
                      ...
                      <li class="map-pin">
                        ...
                        >
                          <path
                            ...
                            clip-rule="evenodd"
                            fill="#000000"
                            d="M12 23.999c.048 0-8-11.582-8-15.999 0-4.419 3.581-8 8-8s8 3.581 8 8c0 4.417-8.084 15.999-8 15.999zm0-19.001c-1.658 0-3.002 1.345-3.002 3.002 0 1.657 1.344 3.002 3.002 3.002 1.657 0 3.002-1.345 3.002-3.002 0-1.658-1.345-3.002-3.002-3.002z"
                          />
                        </svg>
