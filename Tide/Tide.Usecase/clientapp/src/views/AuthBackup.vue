<template>
  <div id="content">
    ...
    <div id="auth-box">
      ...
      <Login v-if="loginMode == 'Login'" key="1"></Login>
...
export default {
    ...
    methods: {
        ...
        async getApplication() {
            return (await this.$http.get(`${this.tide.serverUrl}/application`)).data;
        },
        register() {
            ...
            setTimeout(async () => {
                try {
                    ...
                    this.$bus.$emit("update-menu", { name: "Apply", route: "/apply" });
                } catch (thrownError) {
        ...
        login() {
            ...
            setTimeout(async () => {
                try {
                    var login = await this.tide.loginV2(this.user.email, this.user.password, this.getTemporaryOrkList());
