  ...
  <section id="fields-container">
    ...
    >
      ...
      >
        <button
          class="field-btn"
          :class="{'disabled-field':$store.getters.disabledFields.includes(field + fieldSection.section)}"
      ...
      fields: [
        {
          ...
          color: 'orange',
          fields: [
            'First Name', 'Middle Name', 'Last Name', 'Phone Number', 'Email Address', 'Date of Birth'
          ]
        },
        {
          section: 'Addresses',
        ...
        },
        {
          ...
          color: '#01acfe',
          fields: [
            'Employer', 'Phone Number', 'Email Address', 'Pay'
          ]
        },
        {
          section: 'Credit',
          color: '#CC2A41',
          fields: [
            'Credit Card', 'Personal Loan', 'Other Loan'
          ]
        }
      ],
